...
const testInputs = [
  ...
  {"testFor": 'block to single line comments', "inpStr": `SELECT\n/* I should be a single line comment*/ 'String of Evil',\n/*as should I*/ --'Extra Evil',\n(select max(abc) from dedfefe WHERE id = evil.id\n/* multi line comment in a subselect\n                           good luck!\n                           */\n) AS "subSeLeCt oF eViL",\n/*More single line comments*/ "Field of Evil",\n/*-- is scary*/ 1 AS "value of evil",\n"the end"\nFROM evil`, "expStr": `SELECT\n  -- I should be a single line comment\n  'String of Evil',\n  -- as should I\n  -- 'Extra Evil',\n  (\n    SELECT\n      MAX(abc)\n    FROM dedfefe\n    WHERE id = evil.id\n      /* multi line comment in a subselect\n       good luck!\n       */\n  ) AS "subselect of evil",\n  -- More single line comments\n  "field of evil",\n  -- -- is scary\n  1 AS "value of evil",\n  "the end"\nFROM evil`},
  ...
  {"testFor": 'source lib bug', "inpStr": '1\n-- false', "expStr": "1 -- false"},
  ...
  {"testFor": 'reserved words as field names in table create statement', "inpStr": 'CREATE TABLE table_name (char CHAR(10) not null,who_allows_this int PRIMARY KEY,int CHAR(4) NOT NULL);', "expStr": `CREATE TABLE table_name (\n  "char"                          CHAR(10)                    NOT NULL,\n  "who_allows_this"               INT                         PRIMARY KEY,\n  "int"                           CHAR(4)                     NOT NULL\n);`},
