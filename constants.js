var reservedWords = [
  ...
  'OPTION', 'CURRENT', 'INSTALLATION', 'CASCADE', 'PRIVILEGES', 'ACCESS', 'COPY_INTO', 'COPY_FROM', 'EXCLUDING', 'EXECUTE', 'SEQUENCE', 'NEXT', 'NOCREATE_TABLE', 'DATABASE'
];
...
var reservedDataTypes = [
  ...
  'TIMESTAMP_WITH_TZ', 'TIMESTAMP_WO_TZ', 'TIME_WITH_TZ', 'TIME_WO_TZ'
];
...
var reservedFuncTypes = [
  ...
  'VARCHAR', 'VAR_POP', 'VAR_SAMP', 'WEEK', 'WEEK_ISO', 'YEAR', 'YEARWEEK'
];
