var reservedWords = [
  ...
  'IPV4', 'IPV6', 'IS', 'ISO_WEEK', 'JARO_WINKLER', 'JOIN', 'LAG', 'LARGE', 'LAST_DAY', 'LAST_VALUE', 'LATERAL', 'LEAD', 'LEADING', 'LEAST', 'LEFT', 'LENGTH', 'LESSER', 'LEVENSHTEIN', 'LIKE',
  'LISTAGG', 'LN', 'LOCAL', 'LOCALTIME', 'LOCALTIMESTAMP', 'LOCATE', 'LOG', 'LOWER', 'LOWERCASE', 'LPAD', 'LTRIM', 'MATCH', 'MAX', 'MEMBER', 'MERGE', 'MICROSECOND', 'MICROSECONDS', 'MILLISECOND',
  'MIN', 'MINUTE', 'MOD', 'MODIFIES', 'MODIFY', 'MODULE', 'MONEY', 'MONTH', 'MONTHS_BETWEEN', 'NANOSECOND', 'NANOSECONDS', 'NATURAL', 'NCHAR', 'NEW', 'NO', 'NONE', 'NOT', 'NOTRIM', 'NTILE', 'NULL',
  'NULLIF', 'NULLS', 'NUMERIC', 'NVARCHAR', 'NVL', 'NVL2', 'OCTET_LENGTH', 'OF', 'OLD', 'ONLY', 'OPEN', 'OR', 'ORDER', 'OUT', 'OUTER', 'OVER', 'PARAMETER', 'PARTITION', 'PERCENT_RANK', 'PI',
  'POSITION', 'POWER', 'PRECEDING', 'PRECISION', 'PRIMARY', 'PROCEDURE', 'PUBLIC', 'QUARTER', 'RANDOM', 'RANDOMF', 'RANGE', 'RANK', 'REAL', 'REF', 'REFERENCES', 'REFERENCING', 'REGR_AVGX', 'REGR_AVGY',
  'REGR_COUNT', 'REGR_INTERCEPT', 'REGR_R2', 'REGR_SXX', 'REGR_SYY', 'REPEAT', 'REPLACE', 'RESPECT', 'RESTRICT', 'RETURN', 'REVOKE', 'RIGHT', 'ROLLBACK', 'ROUND', 'ROWS', 'ROW_NUMBER', 'RPAD',
  'SEARCH', 'SECOND', 'SELECT', 'SENSITIVE', 'SET', 'SHIFT', 'SIGN', 'SIMILAR', 'SIN', 'SIZE', 'SIZE', 'SMALLINT', 'SOME', 'SOUNDEX', 'SQL', 'SQRT', 'SQUEEZE', 'STDDEV_POP', 'STDDEV_SAMP',
  ...
  'TIME_FORMAT', 'TIME_LOCAL', 'TIME_WITH_TZ', 'TIME_WO_TZ', 'TINYINT', 'TO', 'TO_CHAR', 'TO_DATE', 'TO_TIME', 'TO_TIMESTAMP', 'TO_TIMESTAMP_TZ', 'TRAILING', 'TRANSLATE', 'TRIM', 'TRUE', 'TRUNC',
  'UNBOUNDED', 'UNION', 'UNIQUE', 'UNIX_TIMESTAMP', 'UNKNOWN', 'UPDATE', 'UPPER', 'UPPERCASE', 'USERNAME', 'USING', 'UUID', 'UUID_COMPARE', 'UUID_CREATE', 'UUID_FROM_CHAR', 'UUID_TO_CHAR', 'VALUE',
  'VALUES', 'VARCHAR', 'VAR_POP', 'VAR_SAMP', 'VIEW', 'WEEK', 'WEEK_ISO', 'WHEN', 'WHERE', 'WINDOW', 'WITH', 'WITHIN', 'WITHOUT', 'YEAR', 'YEARWEEK', 'FIRST', 'LAST', 'KEY', 'DESC', 'ASC', 'TRUNCATED'
];
...
var reservedDataTypes = [
  'INT', 'INTEGER', 'INT1', 'INT2', 'INT4', 'INT8', 'TINYINT', 'SMALLINT', 'BIGINT', 'CHAR', 'NCHAR', 'VARCHAR', 'NVARCHAR', 'BOOLEAN', 'DEC', 'NUMERIC', 'MONEY', 'DECIMAL',
  'TIME', 'TIME WITH TIME ZONE', 'TIME WITHOUT TIME ZONE', 'DATE', 'ANSIDATE', 'TIMESTAMP', 'TIMESTAMP WITH TIME ZONE', 'TIMESTAMP WITHOUT TIME ZONE', 'FLOAT', 'FLOAT4', 'FLOAT8', 'IPV4',
  'IPV6', 'UUID', 'TIMESTAMP_WITH_TZ', 'TIMESTAMP_WO_TZ', 'TIME_WITH_TZ', 'TIME_WO_TZ'
];
